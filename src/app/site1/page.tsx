...
import face1 from "../../../public/page-1/pfp.png";
...
import faces from "../../../public/page-1/faces.svg";
...
import testimg from "../../../public/page-1/Vector 9.png";
import faqimg from "../../../public/page-1/Vector 10.png";
  ...
  return (
    <>
      <section
        ...
        style={{ backgroundImage: "url('/page-1/bg.svg')" }}
      >
      ...
      <section id="services" className="bg-site1-green h-screen px-44 py-24">
        ...
        <div className="mt-24 flex gap-12 z-10">
          ...
          <div className="bg-site1-white rounded-2xl w-fit z-10 px-4 h-fit py-8 flex justify-center flex-col items-center ">
          ...
          <div className="bg-site1-white rounded-2xl w-fit px-4 h-fit z-10 py-8 flex justify-center flex-col items-center    ">
      ...
      <section id="probs" className="px-44 flex flex-col h-fit py-12 ">
        <div>
          <div className="bg-site1-cta h-4 w-24 z-10 "> </div>
            ...
            {familiarGridItems.map((item, index) => {
              ...
              if (item.type === "image") {
                return (
                  <div
                    key={index}
                    className="z-10 w-full h-full bg-site1-green flex flex-col justify-center items-center rounded-2xl"
                  >
                    <Image
                      src={item.src}
                      width={0}
      ...
      <section id="faq" className="flex px-44 py-12 bg-site1-green">
        <div className="w-1/2">
          {" "}
          <Image src={faqimg} width={0} height={0} alt="BACP Logo" />
        </div>
        <div className="w-1/2">
          {" "}
